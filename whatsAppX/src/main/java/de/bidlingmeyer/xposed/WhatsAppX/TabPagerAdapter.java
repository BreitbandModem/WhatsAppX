...
public class TabPagerAdapter extends FragmentStatePagerAdapter {
  ...
  public Fragment getItem(int i) {
      ChatBubbleFragment f = new ChatBubbleFragment();
      Bundle args = new Bundle(3);
      args.putString("conversationName", tabs.get(i)[0]);
      args.putString("tag", tabs.get(i)[2]);
      args.putString("origName", conversationName);
      f.setArguments(args);
	  frags.add(f);
	  return f;
  }
